...
bool_params = {"dev_mode", "resource_cleanup", "deploy", "generate_synthetic_traces", "medallion_lab"}
    ...
    **overrides
    ...
    if dev_mode:
        ...
        try:
            ...
            print("  Skipping manifest validation (no manifest found in directory tree)")
        except ValueError as e:
            print(f"  Skipping manifest validation (course not in manifest: {e})")
        i += 1
    ...
    if dev_mode:
        medallion_lab = params.get("medallion_lab")
